...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	//HCURSOR hCur = LoadCursor(hInstance, MAKEINTRESOURCE(IDC_CURSOR1));
	//HCURSOR hCur = (HCURSOR)LoadImage(hInstance, MAKEINTRESOURCE(IDC_CURSOR1), IMAGE_CURSOR, width, height, LR_DEFAULTCOLOR);
	//HCURSOR hCur = (HCURSOR)LoadImage(hInstance, L"test.cur", IMAGE_CURSOR, width, height, LR_LOADFROMFILE);
