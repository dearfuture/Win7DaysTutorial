...
判断组合键
组合使用Ctrl键与字母键会产生从0x01（Ctrl-A）到0x1A（Ctrl-Z）的ASCII控制代码
bIsCtrl = (::GetAsyncKeyState(VK_CONTROL) & 0x8000);
bIsCtrl = (::GetKeyState(VK_CONTROL) & 0x8000);
...
LRESULT CALLBACK WinProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_COMMAND:
	{
		...
		{
		case ID_40001:
			MessageBox(hWnd, L"40001", L"Message", MB_OK);
			break;
		case ID_40002:
			MessageBox(hWnd, L"40002", L"Message", MB_OK);
			break;
		case ID_40003:
			MessageBox(hWnd, L"40003", L"Message", MB_OK);
			break;
		default:
	...
	case WM_KEYDOWN:
		...
		{
		case VK_ESCAPE:
			MessageBox(hWnd, L"ESC", L"Message", MB_OK);
			break;
		case VK_UP:
			MessageBox(hWnd, L"UP", L"Message", MB_OK);
			break;
	...
	case WM_CHAR:
		...
		case 0x01:  //Ctrl+a
			...
			break;
		case 'a':
			MessageBox(hWnd, L"a", L"Message", MB_OK);
			break;
		case 'A':
			MessageBox(hWnd, L"A", L"Message", MB_OK);
			break;
		case '0':
			MessageBox(hWnd, L"0", L"Message", MB_OK);
			break;
		case '@':
